...
function formatDateWithLocale($date) {
    // Corrigir a data para ter um dia válido, se necessário
    // No exemplo, o dia "00" será ajustado para "01"
    ...
    $locale = 'pt_BR'; // Locale brasileiro
    $formatter = new IntlDateFormatter($locale, IntlDateFormatter::FULL, IntlDateFormatter::LONG);
    
    // Definir o padrão do formato desejado
    $formatter->setPattern('EEEE, dd \'de\' MMMM \'de\' yyyy');

    // Formatar a data e retornar o resultado
