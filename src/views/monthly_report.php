        ...
        <form action="#" method="post" class="mb-4">
            <div class="input-group">
                <?php if($user->is_admin): ?>
                    <select name="user" id="user" class="form-control mr-2" placeholder="Selecione o periodo">
                ...
                <select name="period" id="period" class="form-control" placeholder="Selecione o periodo">
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                <?php foreach ($report as $registry): ?>
                    <tr>
                        <td><?= formatDateWithLocale($registry->work_date);   ?></td>
